                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <button wire:click="edit({{ $professores->id }})" class="flex px-4 py-2 bg-gray-500 text-gray-900 cursor-pointer">Edit</button>
                            <button wire:click="delete({{ $professores->id }})" class="flex px-4 py-2 bg-red-100 text-gray-900 cursor-pointer">Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
